...
One run through the team, condensed. The case is invented. It is here so you can see the shape of the documents and how the roles hand off, not because your project should look like this one. A different goal staffs a different team and produces different documents.
...
### context.md (excerpt)
    ...
    ## Buyer
    - Who: quilters who inherited a pre-1970 domestic machine [confirmed]
    - What they do today: YouTube, or give up and buy new [confirmed]

    ## Constraints
    - Hours per week: 4 [confirmed]
    - Budget: 0 [confirmed]

    ## Competitors
    - [UNKNOWN: watches two channels, cannot name them. Assumption in use:
...
## Researcher (excerpt)
    ...
    ## Gaps
    - Neither channel sells anything visible, so no pricing comparison is
      possible. [confirmed by inspection, 2026-09-06]
    - Whether quilters specifically search for repair help, versus sewers
      generally, could not be established without keyword tooling.
      [assumed: quilter-specific demand exists, based on six years of walk-in
      customers being mostly quilters. Resolves when: first month of search data.]
...
## Strategist (excerpt)
    ...
    Six years of hands-on repairs on the exact machines these people inherited,
    ...
    ## Claims and proof
    | Claim | Proof required | Exists? |
    | Six years repairing these machines | user statement | yes [confirmed] |
    | Most inherited machines need the same three fixes | a count from actual
      repair history | NO. Do not use until counted. |

That last row is the point of the table. It is the best line available and it cannot be used yet.

---

## Content strategist (excerpt)

    ## Cadence reality check
    Hours available: 4 [confirmed]
    Hours required: 3
    One written teardown every two weeks. Halved from the weekly plan four
    hours appeared to support, because four is the number people give before
    remembering the rest of their life.

    ## Editorial standards
    Every repair described must have been performed by the user. Nothing gets
    published from research alone. This is a first-hand business and a
    fabricated claim destroys the only advantage it has.
